                ...
                <div className="user">
                    {
                        ...
                        <div className='no-user'>
                            <button className='btn-login' onClick={() => {navigate('/login', {replace: true})}}>Fazer login</button>
                            <button className='btn-register' onClick={() => {navigate('/register', {replace: true})}} >Cadastrar</button>
                        </div>
                    }
                </div>
            </div>
                ...
                <Menu>
                    ...
                    <MenuList borderRadius='0' borderLeft='none' minW='95vw' w='100vmin' ref={dropRef}>
                        <MenuGroup>
                            ...
                            <MenuItem fontWeight='600' pl='16px' color='var(--color-grey-2)' mb='32px' fontSize='16px'>Leilão</MenuItem>
                        </MenuGroup>
                        <MenuDivider border='' borderBottom='3px solid var("--color-grey-4")'/>
                        <MenuGroup pl='22px'>
                        {
                                Object.keys(new_user_buyer).length ?
                                <div className='user-logged'>
                                ...
                                :
                                <div className='no-user'>
                                    <MenuItem mt='32px' mb='44px' fontWeight='600' pl='12px' color='var(--color-grey-2)' fontSize='16px' onClick={() => {navigate('/login', {replace: true})}}>Fazer login</MenuItem>
                                    <MenuItem borderRadius='4px' fontSize='16px' display="flex" alignItems="center" justifyContent="center" w='90%' border='1.5px solid var(--color-grey-4)' mb='32px' pl='12px' onClick={() => {navigate('/register', {replace: true})}} >Cadastrar</MenuItem>
                                </div>
                        }
                        </MenuGroup>
                    </MenuList>
