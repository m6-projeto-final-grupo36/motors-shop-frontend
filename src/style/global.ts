...
:root {
    ...
    --font-heading-1-700: font-weight: 700px;
    --font-heading-2-600: font-weight: 600px;
    --font-heading-3-600: font-weight: 600px;
    --font-heading-3-500: font-weight: 500px;
    --font-heading-4-600: font-weight: 600px;
    --font-heading-4-500: font-weight: 500px;
    --font-heading-5-600: font-weight: 600px;
    --font-heading-5-500: font-weight: 500px;
    --font-heading-6-600: font-weight: 600px;
    --font-heading-6-500: font-weight: 500px;
    --font-heading-7-600: font-weight: 600px;    
    --font-heading-7-500: font-weight: 500px;
}
`;
